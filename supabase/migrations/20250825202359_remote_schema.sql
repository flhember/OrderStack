...
CREATE POLICY "All authenticated users All operation" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);
